...
import { useRouter } from "next/navigation"; // Novo za preusmeritev
...
export default function BetsPage() {
  ...
  const [loading, setLoading] = useState(true); // Začnemo s true
  ...
  useEffect(() => {
    ...
    const checkAccess = async () => {
      ...
      // Če ni profila ali ni odobren (in ni tvoj admin email)
  ...
  async function loadBets() {
    // Te vrstice se zdaj izvajajo samo po uspesnem checku v useEffectu
